...
// No longer updated automatically. Update only for major version changes.
#define EXE_VERSION_NUM 160000
...
// 150000 : XML Project, first reliable version which stored Module Info 'class'.
