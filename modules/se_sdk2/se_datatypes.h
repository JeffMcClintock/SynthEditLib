...
enum EPlugDataType : int8_t { DT_ENUM, DT_TEXT, DT_MIDI2, DT_MIDI = DT_MIDI2, DT_DOUBLE, DT_BOOL, DT_FSAMPLE, DT_FLOAT, DT_VST_PARAM, DT_INT, DT_INT64, DT_BLOB, DT_CLASS, DT_STRING_UTF8, DT_OBJECT, DT_NONE=-1 };  //plug datatype
