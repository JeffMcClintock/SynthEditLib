...
public:
	...
	void OnRender(GmpiDrawing::Graphics& dc) override
	{
	...
	void onPointerMove(int32_t flags, GmpiDrawing_API::MP1_POINT point) override
	{
...
//			_RPT1(_CRT_WARN, "onPointerMove %d\n", currentQuantizedValue);
	...
	GmpiDrawing::Size getSize() override
	{
	...
	GmpiDrawing::Point getKnobCenter() override
	{
		if (!bitmap_.isNull())
		{
