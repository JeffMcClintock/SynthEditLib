...
#define REGISTER_GUI_PLUGIN( className, pluginId ) namespace{ gmpi::IMpUnknown* PASTE_FUNC(create, className)(){ return static_cast<gmpi::IMpUserInterface*> (new className(0)); }; int32_t PASTE_FUNC(r, className) = SE_REGISTER_PLUGIN_FUNC( gmpi::MP_SUB_TYPE_GUI, pluginId, &PASTE_FUNC(create, className) );}

#define GMPI_REGISTER_GUI( family, className, pluginId ) namespace{ gmpi::IMpUnknown* PASTE_FUNC(create, className)(){ return static_cast<class MpGuiBase2*>(new className()); }; int32_t PASTE_FUNC(r, className) = SE_REGISTER_PLUGIN_FUNC( family, pluginId, &PASTE_FUNC(create, className) );}
//#define GMPI_REGISTER_CONTROLLER( className, pluginId ) namespace{ gmpi::IMpUnknown* PASTE_FUNC(create, className)(){ return static_cast<class gmpi::IMpController*>(new className()); }; int32_t PASTE_FUNC(r, className) = SE_REGISTER_PLUGIN_FUNC( gmpi::MP_SUB_TYPE_CONTROLLER, pluginId, &PASTE_FUNC(create, className) );}
...
{
return SE_REGISTER_PLUGIN_FUNC(gmpi::MP_SUB_TYPE_GUI, moduleIdentifier,
