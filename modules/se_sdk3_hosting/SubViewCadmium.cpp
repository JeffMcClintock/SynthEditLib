...
int32_t SubViewCadmium::StartCableDrag(SE2::IViewChild* fromModule, int fromPin, Point dragStartPoint, bool isHeldAlt, SE2::CableType type)
{
...
void SubViewCadmium::OnCableDrag(SE2::ConnectorViewBase* dragline, GmpiDrawing::Point dragPoint, float& bestDistance, SE2::IViewChild*& bestModule, int& bestPinIndex)
{
	dragPoint -= offset_;
...
int32_t SubViewCadmium::setCapture(SE2::IViewChild* module)
{
...
//		Matrix3x2::Translation(0,0) * //parentLayoutRect.left /2, parentLayoutRect.top/2) *
	...
	// Render.
	//auto r = SE2::ViewBase::OnRender(drawingContext);
