...
public:
	...
	int32_t getCount( int32_t &returnCount ) override
    {
	...
	int32_t getPinId( int32_t& returnValue ) override
    {
	...
	int32_t getPinDirection( int32_t& returnValue ) override
    {
	    returnValue = (*it_)->Direction;
	    return gmpi::MP_OK;
    }
    int32_t getPinDatatype( int32_t& returnValue ) override
    {
