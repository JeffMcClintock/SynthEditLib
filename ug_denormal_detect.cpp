...
{
REGISTER_MODULE_1(L"Denormal Detector", IDS_MN_DENORMAL_DETECTOR, IDS_MG_OLD,ug_denormal_detect,CF_STRUCTURE_VIEW,L"A diagnostic module to indicate DeNormal numbers in the audio.  Connect to a LED for visual indication.  Denormal numbers are VERY small values that are inaudible, but waste CPU resources.");
}
