...
namespace
{
REGISTER_MODULE_1(L"Sample and Hold", IDS_MN_SAMPLE_AND_HOLD,IDS_MG_OLD,ug_sample_hold ,CF_STRUCTURE_VIEW,L"Sample and Hold Module");
}
...
void ug_sample_hold::ListInterface2(std::vector<class InterfaceObject*>& PList)
{
